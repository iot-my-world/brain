...
func (e DeviceRetrieval) Error() string {
	return "error retrieving backend: " + strings.Join(e.Reasons, "; ")
}
...
func (e DeviceUpdate) Error() string {
	return "error updating backend: " + strings.Join(e.Reasons, "; ")
}
...
func (e DeviceCreation) Error() string {
	return "error creating backend: " + strings.Join(e.Reasons, "; ")
}
