...
import (
	...
	zx303StatusReadigRecordHandler "gitlab.com/iotTracker/brain/tracker/zx303/reading/status/recordHandler"
	"gopkg.in/mgo.v2"
)
...
func New(
...
) *zx303StatusReadigRecordHandler.RecordHandler {
	...
	return zx303StatusReadigRecordHandler.New(
		mongoRecordHandler,
	)
}
